...
def main():
    df = pd.read_csv("./Project3_Power_Consumption.csv")
    ...
    # Plotting starts here
        ...
        #print(len(km.centroids[centroid]))
        for centroid in km.centroids:
            print(km.centroids[centroid][0], km.centroids[centroid][1], km.centroids[centroid][2], km.centroids[centroid][3], km.centroids[centroid][4], km.centroids[centroid][5], km.centroids[centroid][6])
